...
import com.agroprod.dao.BuyerDAO;
...
public class BuyerService {
	...
	public boolean existingBuyer(String name) {
		boolean existingBuyerFlag = false;
		Buyer findByBuyerName = buyerDAO.findByBuyerName(name);

		if (findByBuyerName != null) {
			existingBuyerFlag = findByBuyerName.getBuyerName().equalsIgnoreCase(name);
		}

		return existingBuyerFlag;
